package com.nezha.house.config.timezone;

import com.nezha.house.HouseGatewayApp;
import com.nezha.house.config.SecurityBeanOverrideConfiguration;
import com.nezha.house.repository.timezone.DateTimeWrapper;
import com.nezha.house.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, HouseGatewayApp.class})
