...
@RestController
@RequestMapping("/api/house-gateway-kafka")
public class HouseGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HouseGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HouseGatewayKafkaResource(KafkaProperties kafkaProperties) {
